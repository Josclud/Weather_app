$(document).ready(function () {
  ...
  function weatherSearch(searchTerm) {
    $.ajax({
      url: "https://api.openweathermap.org/data/2.5/weather?q=" + searchTerm + "&appid=9039ae56ad2cbd4d4807aae9d394e343&units=imperial",
      method: "GET",
  ...
  function forecast(searchTerm) {
    $.ajax({
      url: "https://api.openweathermap.org/data/2.5/forecast?q=" + searchTerm + "&appid=9039ae56ad2cbd4d4807aae9d394e343&units=imperial",
      method: "GET",
